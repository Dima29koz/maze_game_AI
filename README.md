...
```bash
python -m scripts.train --algo ppo --env MiniGrid-DoorKey-8x8-v0 --model DoorKey --save-interval 10 --frames 500000
...
```bash
python -m scripts.visualize --env MiniGrid-DoorKey-8x8-v0 --model DoorKey
...
MiniGrid-Unlock-v0 example - it works
```bash
python -m scripts.train --algo ppo --env MiniGrid-Unlock-v0 --model MiniGridUnlock --save-interval 10 --frames 500_000
python -m scripts.visualize --env MiniGrid-Unlock-v0 --model MiniGridUnlock
```
